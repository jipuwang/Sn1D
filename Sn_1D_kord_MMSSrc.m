...
%% For the fast group
    ...
    % + (Sig_t-Sig_ss)*0.5 * ( +1.5593897658139900E-03 x^2 -1.3533502228265900E-03 x +6.3255899575709700E-02 )
    ...
    % + (Sig_t-Sig_ss)*0.5 * ( -4.4443431764232400E-03 x^2 +2.6590845920514000E-01 x -2.8376294939004300E+00 )
    ...
    % + (Sig_t-Sig_ss)*0.5 * ( +1.6006807673739400E-03 x^2 -1.8963240555487500E-01 x +5.6794357067491300E+00 )
    % (Sig_t-Sig_ss)*0.5 in this case is 1.5034250000000000E-02
    for j=2/3*J+1:J
        for n=1:N
...
%% For thermal group
    ...
    % + (Sig_t-Sig_ss)*0.5 * ( +3.7420664087460500E-04 x^2 +3.2444814149334100E-03 x +1.2139249518777500E-02 )
    ...
    % + (Sig_t-Sig_ss)*0.5 * ( -1.2351628643713800E-03 x^2 +7.3932137536755800E-02 x -7.5807942857102300E-01 )
    % - Sig_g1_rm*0.5 * (phi_g1_MMS)
    ...
    % + (Sig_t-Sig_ss)*0.5* ( +3.6321032591887700E-04 x^2 -4.7314818437341200E-02 x +1.5394028032516800E+00 )
    % - Sig_g1_rm*0.5 * (phi_g1_MMS)
    % (Sig_t-Sig_ss)*0.5 in this case is +4.4870000000000200E-03
    for j=2/3*J+1:J
        for n=1:N
